...
public ParameterForm query(){
    ...
    String sql = "select * from t_parameter where id=1";
...
public int update(ParameterForm parameterForm){
    String sql="UPDATE t_parameter SET cost="+parameterForm.getCost()+",validity="+parameterForm.getValidity()+" where id=1";
