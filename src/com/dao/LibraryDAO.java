...
public class LibraryDAO {
    ...
    public LibraryForm query(){
        ...
        String sql = "select * from t_library where id=1";
    ...
    public int update(LibraryForm libraryForm){
        String sql="UPDATE t_library SET libraryname='"+libraryForm.getLibraryname()+"',curator='"+libraryForm.getCurator()+"',tel='"+libraryForm.getTel()+"',address='"+libraryForm.getAddress()+"',email='"+libraryForm.getEmail()+"',url='"+libraryForm.getUrl()+"',createDate='"+libraryForm.getCreateDate()+"',introduce='"+libraryForm.getIntroduce()+"' where id=1";
        int ret=0;
        try{
        	ret=conn.executeUpdate(sql);
        }catch(Exception e){
        	System.out.println("�޸�ͼ�����Ϣ��"+e.getMessage());
        }
