...
%>
  ...
  <tr>
    <td>
      <a href="${pageContext.request.contextPath }/readerType_add.jsp" target='_blank' >添加读者类型信息</a> </td>
  </tr>
</table>
 <%
}else{
...
<%
  ...
  <tr>
    ...
    <td align="center" style="padding:5px;">&nbsp;<%=number%></td>
    <td align="center"><a href="${pageContext.request.contextPath }/readerType.do?action=readerTypeModifyQuery&ID=<%=ID%>" target='_blank'>修改</a></td>
    <td align="center"><a href="${pageContext.request.contextPath }/readerType.do?action=readerTypeDel&ID=<%=ID%>">删除</a></td>
  </tr>
<%
  }
}
