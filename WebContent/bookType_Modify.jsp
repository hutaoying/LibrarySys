...
<table width="292" height="175" border="0" cellpadding="0" cellspacing="0" background="Images/subBG.jpg"align='center'>
 ...
 <input name="id" type="hidden" size="50" value="<%=bookTypeForm.getId()%>"> 
  ...
  <tr>
    ...
    <td width="71%"><input name="typeName" type="text" size="30" value="<%=bookTypeForm.getTypeName()%>" readonly="readonly">
      </td>
  </tr>
  <tr>
    <td align="center">可借天数：</td>
    <td><input name="days" type="text" size="25" placeholder="<%=bookTypeForm.getDays()%>">
      (天)</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
