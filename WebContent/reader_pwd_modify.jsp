...
<%
ReaderForm readerForm=(ReaderForm)request.getAttribute("pwdQueryif");
%>
<head>
<link rel="stylesheet"
...
function checkForm(form){
	...
	if(form.password.value==""){
		alert("请输入的新密码!");form.password.focus();return false;
	}	
	if(form.pwd1.value==""){
		alert("请确认新密码!");form.pwd1.focus();return false;
	}	
	if(form.password.value!=form.pwd1.value){
 ...
 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
...
</table>  <form name="form1" method="post" action="reader.do?action=modifypwd">
  ...
  <tr align="center">
    ...
    <td width="73%" align="left">
      <input name="name" type="text" id="name" value="<%=readerForm.getName()%>" readonly="yes" size="30">    </td>
    <tr>
    <td align="left" style="padding:5px;">原始密码：</td>
    <td align="left"><input name="oldpwd" type="text" id="oldpwd" size="30" value="<%=readerForm.getPassword()%>" readonly="yes">
     </td>
    </tr>
    <tr>
      <td align="left" style="padding:5px;">新密码：</td>
      <td align="left"><input name="password" type="password" id="pwd" size="30"></td>
    </tr>
    <tr>
