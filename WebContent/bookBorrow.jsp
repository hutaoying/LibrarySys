...
<link href="CSS/family.css" rel='stylesheet' type='text/css'>
		...
		function checkreader(form){
			if(form.numid.value==""){
				alert("请输入读者条形码!");form.numid.focus();return;
			}
			form.submit();
		}
		function checkbook(form){
			if(form.f.value==""){
				alert("请输入读者条形码!");form.f.focus();return;
			}		
                  ...
                  <tr>
                    <td><table width="90%" height="21" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="76%" style="padding-top:7px;">读者学号/教职工号：
...
<input name="inputkey" type="text" id="inputkey" size="50">
                   ...
                   <input name="operator" type="hidden" id="operator" value="<%=user%>">
...
%>
                   <tr>
                     <td height="25" style="padding:5px;"align="center">&nbsp;<%=bookname%></td>
                     ...
                     <td align="center"align="center">&nbsp;<%=pubname%></td>
