...
<table width="292" height="175" border="0" cellpadding="0" cellspacing="0" background="Images/subBG.jpg" align='center'>
 ...
 <input name="id" type="hidden" size="50" value="<%=readerTypeForm.getId()%>"> 
  ...
  <tr>
    ...
    <td width="72%"><input name="name" type="text" size="28" value="<%=readerTypeForm.getName()%>"  readonly="readonly">
      </td>
  </tr>
  <tr>
    <td align="center">可借数量：</td>
    <td><input name="number" type="text" size="25" placeholder="<%=readerTypeForm.getNumber()%>">
      (本)</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
