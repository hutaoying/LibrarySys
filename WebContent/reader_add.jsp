...
function check(form){
	...
	if(form.numid.value==""){
		alert("请输入学号/教职工号!");form.numid.focus();return false;
	}
...
<table width="778"  border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
	...
	<table width="700" height="432"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        <td align="center">学号/教职工号：</td>
        <td><input name="numid" type="text" id="barcode">
* </td>
      </tr>
      <tr>
...
<%}%> 
      ...
      </tr><pre style="color:red">外校人员务必填写身份证号，可以用身份证后六位作为numid</pre>
      <tr>
